...
moment.period = function (dateString) {
    ...
    if (typeof dateString == 'string' && dateString !== '' ) {
        ...
        if (period == 'week') {
            ...
            endDate = moment().add(modifierNumber * modifierOperation, 'weeks').isoWeekday(7);
        }
...
// We redefine the moment object without reexporting it.
// So the above code is used as a plugin directly plugged onto the moment object.
